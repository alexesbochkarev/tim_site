"""
Django settings for tim_site project.
...
ROOT_URLCONF = "tim_site.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [BASE_DIR / "tim_site"]
        ,
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
                ...
                "tim_site.context_processor.get_context_data"
            ],
        },
    },
]

WSGI_APPLICATION = "tim_site.wsgi.application"
...
CODE_MASTER_KEY = "112"
CODE_ALIVE_TIMEDELTA = datetime.timedelta(minutes=15)

QRCODE_URL_SCHEME = ("http" if DEBUG else "https") + "://" + \
